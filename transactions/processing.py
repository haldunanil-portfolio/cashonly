...
class ProcessTransaction(object):
    ...
    def calculate_stripe_fee(*args, **kwargs):
        """
    ...
    def calculate_shared_revenue(variable_rate=0.05, fixed_rate=100,
                                 pay_as_you_go=False, *args, **kwargs):
        """

        """
        cash_only_commission = calculate_commission(
            self.amount, variable_rate, fixed_rate, pay_as_you_go, *args, **kwargs
        )
    ...
    def calculate_business_share(business, variable_rate=0.05, fixed_rate=100,
                                 pay_as_you_go=False, *args, **kwargs):
        """

        """
        shareable_revenue = calculate_shared_revenue(
            self.amount, variable_rate, fixed_rate, pay_as_you_go, *args, **kwargs
        )
